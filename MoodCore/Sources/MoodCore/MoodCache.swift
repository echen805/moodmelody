...
@MainActor
public class MoodCache: ObservableObject {
    public static let shared = MoodCache()
    ...
    public func cacheTracks(_ tracks: [Track], for mood: MoodType) {
        do {
    ...
    public func getCachedTracks(for mood: MoodType) -> [Track]? {
    ...
    public func isLiked(trackID: String, for mood: MoodType) -> Bool {
    ...
    public func getLikedTracks(for mood: MoodType) -> [Track] {
